shinyServer(function(input, output, session){
  ...
  ###
   ...
   ## SIMPOL Dashboard Overview
   callModule(module = frontSIMPOLModule,id ="SIMPOL")

   #Maps module
   callModule(module = mapModule,id="MapModule",SSC)
   callModule(module = qualityMapModule,id="QualityMapModule",mapData=mog,stats=stats)
   callModule(module = spillMapModule,id="SpillMapModule",ldnbound)
   callModule(module = forecastModule,id="ForecastModule",SSC)
   ###DATA upload module
   callModule(module = uploadDataModule,id="UploadDataModule")
   callModule(module = dlForecastModule,id="DownloadData")
   callModule(module = analysisModule,id="Analysis",mapData=mog,stats=stats)
